                        ...
                        <div className="flex items-center gap-3">
                            {[FiFacebook, FiTwitter, FiInstagram, FiLinkedin, FiYoutube].map((Icon, i) => (
                                <a
                                    key={i}
                                    href="#"
                                    className="w-9 h-9 rounded-lg bg-blue-900/30 flex items-center justify-center text-blue-400 hover:bg-blue-600 hover:text-white transition-all duration-300"
                                >
                        ...
                        <ul className="space-y-2.5">
                            {quickLinks.map((link) => (
                                <li key={link.path}>
                                    <Link
                                        to={link.path}
                                        className="hover:text-blue-500 text-sm transition-colors flex items-center gap-2 group" style={{ color: 'var(--text-muted)' }}
                                    >
                                        <span className="w-1.5 h-1.5 rounded-full bg-blue-600 group-hover:bg-blue-400 transition-colors flex-shrink-0" />
                                        {link.name}
                                    </Link>
                                </li>
                            ))}
                    ...
                    <div>
                        ...
                        <ul className="space-y-4">
                            ...
                            <li className="flex items-center gap-3">
                                ...
                                <a href="tel:+18001234567" className="text-gray-400 hover:text-blue-400 text-sm transition-colors">+1 (800) 123-4567</a>
                            </li>
                            <li className="flex items-center gap-3">
                                <FiMail className="text-blue-400 text-lg flex-shrink-0" />
                                <a href="mailto:info@securevision.com" className="text-gray-400 hover:text-blue-400 text-sm transition-colors">info@securevision.com</a>
                            </li>
                        </ul>
                        <div className="mt-5 p-3 rounded-lg" style={{ background: 'rgba(239,68,68,0.1)', border: '1px solid rgba(239,68,68,0.2)' }}>
                            ...
                            <a href="tel:+18009999911" className="text-red-300 text-sm font-bold hover:text-red-200 transition-colors">+1 (800) 999-9911</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div style={{ borderTop: '1px solid var(--border-soft)' }}>
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-5 flex flex-col sm:flex-row items-center justify-between gap-3">
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <a href="#" className="text-gray-500 hover:text-gray-400 text-xs transition-colors">Cookie Policy</a>
                    </div>
                </div>
            </div>
        </footer>
