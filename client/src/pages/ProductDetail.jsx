                    ...
                    <div className="flex flex-col-reverse md:flex-row gap-4">
                        ...
                        <div className="flex flex-row md:flex-col gap-3">
                            {[product.img, product.img, product.img].map((img, i) => (
                                <button
                                    ...
                                    className={`w-20 h-20 border-2 p-2 bg-gray-50 transition-all ${activeImg === i ? 'border-blue-600' : 'border-gray-100 hover:border-gray-200'}`}
                                >
                        ...
                        <div className="flex-grow aspect-square bg-gray-50 flex items-center justify-center p-12 border border-gray-100 relative group overflow-hidden">
                            ...
                            <div className="absolute top-6 right-6 flex flex-col gap-3">
                                <button className="p-3 bg-white rounded-full shadow-lg text-gray-400 hover:text-red-500 transition-all">
                                    <FiHeart />
                                </button>
                                <button className="p-3 bg-white rounded-full shadow-lg text-gray-400 hover:text-blue-600 transition-all">
                                    <FiShare2 />
                                </button>
                            </div>
                        </div>
                ...
                <div className="flex-grow space-y-8">
                    ...
                    <div className="space-y-6">
                        <div className="flex flex-wrap items-center gap-3">
                            <Link
                                to="/book-technician"
                                className="flex-grow md:flex-none h-11 bg-[#0F1111] text-white px-8 rounded-full font-bold text-sm transition-all hover:bg-gray-800 hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-gray-200 flex items-center justify-center"
                            >
                                Book a Slot
                            </Link>
                            ...
                            <Link
                                ...
                                className="flex-grow md:flex-none h-11 bg-white border-2 border-[#0F1111] text-[#0F1111] px-8 rounded-full font-bold text-sm transition-all hover:bg-gray-50 hover:scale-[1.02] active:scale-95 flex items-center justify-center"
                            >
                                Enquiry
                            </Link>

                            <button className="w-11 h-11 flex items-center justify-center border-2 border-gray-100 rounded-full text-gray-600 hover:bg-blue-600 hover:text-white hover:border-blue-600 transition-all">
                    ...
                    {related.slice(0, 4).map(p => (
                        <Link key={p.id} to={`/products/${p.slug}`} className="group space-y-4">
                            ...
                            <div className="space-y-1">
                                <p className="text-sm font-bold text-gray-900 group-hover:text-blue-600 transition-colors line-clamp-1">{p.name}</p>
