                                ...
                                >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="pt-4 flex gap-2">
                                            <Link
                                                to={`/products/${p.slug}`}
                                                className="flex-grow bg-white border-2 border-black text-black hover:bg-gray-100 py-3 px-4 rounded-none text-sm font-bold text-center transition-colors"
                                            >
                                                View Details
                                            </Link>
