                        ...
                        <div className="bg-white shadow-sm border border-gray-100 rounded-sm overflow-hidden">
                            ...
                            <AnimatePresence>
                                {sections.categories && (
                                    ...
                                    >
                                        <div className="flex items-center gap-3 text-sm cursor-pointer hover:text-blue-600" onClick={() => setCategory('All')}>
                                        ...
                                        {categories.map(([name, count]) => (
                                            <div
                                                key={name}
                                                className="flex items-center justify-between text-sm cursor-pointer hover:text-blue-600 transition-colors"
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4">
                            {filteredProducts.map((p) => (
                                <motion.div
                                    layout
                                    key={p.id}
                                    className="bg-white border border-gray-100 rounded-none p-3 hover:shadow-xl transition-all group"
                                >
                                    {/* Image Container */}
                                    <div className="relative aspect-square bg-gray-50 mb-4 flex items-center justify-center p-6">
                                        ...
                                        />
                                        <button className="absolute top-4 right-4 w-9 h-9 bg-white rounded-full flex items-center justify-center shadow-md text-gray-400 hover:text-red-500 transition-colors">
                                            <FiHeart />
                                        </button>
                                    </div>
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="pt-4 flex gap-2">
                                            <Link
                                                to={`/products/${p.slug}`}
                                                className="flex-grow bg-[#0F1111] text-white py-3 px-4 rounded-full text-sm font-bold text-center hover:bg-gray-800 transition-colors"
                                            >
                                                View Details
                                            </Link>
                                            <button className="p-3 bg-gray-100 text-gray-600 rounded-full hover:bg-blue-600 hover:text-white transition-all">
                                                <FiShoppingBag />
                                            </button>
                                        </div>
                                    </div>
