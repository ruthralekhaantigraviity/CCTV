...
export default function Dashboard() {
 ...
 className={`w-full flex items-center gap-4 px-4 py-3 rounded-lg text-sm font-semibold transition-all ${activeTab === item.id ? 'bg-card text-blue-600 shadow-sm border border-gray-100' : 't-primary '}`}
 >
 ...
 <button
 onClick={logout}
 className="w-full flex items-center gap-4 px-4 py-3 rounded-lg text-sm font-bold text-red-500 dark: transition-all"
 >
 <FiLogOut /> Logout
 </button>
 </aside>
