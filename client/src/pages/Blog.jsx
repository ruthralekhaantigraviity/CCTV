                        ...
                        {posts.map((post, i) => (
                            ...
                            >
                                ...
                                <div className="p-6">
                                    ...
                                    <h2 className="font-bold text-lg mb-3 leading-snug group-hover:text-blue-500 transition-colors" style={{ color: 'var(--text-primary)' }}>
                                        {post.title}
                                    </h2>
                                    ...
                                    <a href="#" className="inline-flex items-center gap-1.5 text-sm font-semibold text-blue-500 hover:text-blue-400 transition-colors group/link">
