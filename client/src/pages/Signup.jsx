                ...
                <div className="md:col-span-3 p-8 md:p-12">
                    ...
                    <form onSubmit={handleSubmit} className="space-y-5">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className={`w-full py-4 bg-[#0F1111] text-white font-black rounded-xl flex items-center justify-center gap-3 hover:bg-gray-800 transition-all shadow-xl shadow-gray-200 uppercase tracking-widest text-xs mt-4 ${loading ? 'opacity-70 cursor-not-allowed' : ''}`}
                        >
