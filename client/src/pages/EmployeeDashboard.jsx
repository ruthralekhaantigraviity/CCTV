            ...
            <aside className="w-24 lg:w-72 bg-white border-r border-gray-100 flex flex-col transition-all duration-300 z-20">
                ...
                <div className="p-6 mt-auto border-t border-gray-100">
                    <button
                        ...
                        className="w-full flex items-center justify-center lg:justify-start gap-4 px-4 py-3 text-red-500 font-semibold text-lg rounded-none transition-all group"
                    >
