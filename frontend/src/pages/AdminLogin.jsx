          ...
          {error && (
            <div className="space-y-4 mb-8 text-left">
              <motion.div
                ...
                className="p-5 bg-red-50 border border-red-100 text-red-600 text-[10px] font-bold rounded-none flex items-center gap-4 uppercase tracking-widest leading-relaxed"
              >
          ...
          <form onSubmit={handleSubmit} className="space-y-8">
            <div className="space-y-3">
              ...
              <input
                ...
                className="w-full px-7 py-5 bg-slate-50 border border-slate-200 rounded-none focus:bg-white focus:border-blue-500/50 focus:ring-4 focus:ring-blue-500/10 outline-none transition-all text-slate-900 font-bold text-sm placeholder:text-slate-300"
              />
            </div>
