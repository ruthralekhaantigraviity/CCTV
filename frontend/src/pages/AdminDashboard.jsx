...
import {
    ...
    FiTruck, FiMail, FiSettings, FiLogOut, FiFileText
} from 'react-icons/fi';
...
export default function AdminDashboard() {
    ...
    if (authLoading) return (
        <div className="min-h-screen flex items-center justify-center bg-white whitespace-pre">
            <div className="w-12 h-12 border-4 border-blue-600 border-t-transparent rounded-full animate-spin" />
            <span className="ml-4 font-bold text-slate-800 uppercase tracking-widest">Verifying Admin Access...</span>
        </div>
    );
    ...
    return (
        <div className="flex min-h-screen bg-white font-sans text-slate-900 admin-theme">
            {/* Sidebar */}
