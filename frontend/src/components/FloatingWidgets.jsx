...
export default function FloatingWidgets() {
 ...
 <button
 type="submit"
 className="absolute right-2 top-1/2 -translate-y-1/2 w-8 h-8 bg-blue-600 text-white rounded-lg flex items-center justify-center transition-colors"
 >
 <FiSend size={14} />
 </button>
 </div>
 ...
 className="w-14 h-14 rounded-full bg-blue-600 text-white shadow-xl flex items-center justify-center transition-all duration-300 relative group"
 >
 {isOpen ? <FiX size={24} /> : <FiMessageCircle size={24} />}
 <span className="absolute right-full mr-4 bg-gray-900 text-white text-[10px] font-bold uppercase tracking-widest px-3 py-1.5 rounded-lg opacity-0 group- transition-opacity whitespace-nowrap pointer-events-none shadow-xl border border-white/10">
 Chat with AI
 </span>
 {!isOpen && (
